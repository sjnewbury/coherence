...
class CoherencePlugin(rb.Plugin, log.Loggable):
    ...
    def activate(self, shell):
        ...
        if os.path.exists(face_path):
            file = Gio.File.new_for_path(face_path);
            url = file.get_uri();
    ...
    def create_configure_dialog(self, dialog=None):
        if dialog is None:
            ...
            label = Gtk.Label(label="Network Interface:")
            ...
            table.attach(interface_entry, 1, 2, 0, 1,
                         xoptions=Gtk.AttachOptions.FILL|Gtk.AttachOptions.EXPAND,yoptions=Gtk.AttachOptions.FILL|Gtk.AttachOptions.EXPAND,xpadding=5,ypadding=5)
            ...
            label = Gtk.Label(label="UPnP version:")
            label.set_alignment(0,0.5)
            table.attach(label, 0, 1, 3, 4)

            dms_version_entry = Gtk.ComboBoxText()
            ...
            dmr_version_entry = Gtk.ComboBoxText()
