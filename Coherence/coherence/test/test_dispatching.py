...
class TestSignalingDescriptors(unittest.TestCase):
    ...
    def test_double_same_var(self):
        ...
        self._check(values = [('same-signal', ('A1',), {}), ('same-signal', ('B2',), {})])
        # empty
        self.signaler.emitted = []
        ...
        self._check(values = [('same-signal', ('B1',), {}), ('same-signal', ('A2',), {})])

    def test_double_differnt_var(self):
        self.signaler.double_c = 'A1'
        self.signaler.double_d = 'B2'
        self._check(values = [('dif-var', ('A1',), {}), ('dif-var', ('B2',), {})])
        # empty
        self.signaler.emitted = []
        self.signaler.double_c = 'A1'
        self.signaler.double_d = 'B2'
        ...
        self._check(values = [('dif-var', ('B1',), {}), ('dif-var', ('A2',), {})])

    def test_custom(self):
        self.signaler.x = 'Pocahontas'
        self._check(values = [('x-changed', ('Pocahontas',), {})], x = 'Pocahontas', x_get = 2, x_set = 1)
    ...
    def test_custom_square(self):
        ...
        self._check(values = [('x-square', (100,), {})], x = 100, x_get = 2, x_set = 1)
