...
class Resource(object):
    ...
    def get_additional_info(self, upnp_client = ''):
        _protocol, _network, content_format, additional_info = self.protocolInfo.split(':')
    ...
    def transcoded(self, p_format):
        protocol, network, content_format, _additional_info = self.protocolInfo.split(':')
        dlna_tags = simple_dlna_tags[:]
        ...
        new_res = Resource(self.data + '/transcoded/%s' % p_format, new_protocol_info)
        new_res.size = None
...
class Object(log.Loggable):
    ...
    def __init__(self, p_id = None, parentID = None, title = None, restricted = False, creator = None):
        self.id = p_id
...
class Container(Object):
    ...
    def __init__(self, p_id = None, parentID = None, title = None,
                 restricted = False, creator = None):
        Object.__init__(self, p_id, parentID, title, restricted, creator)
        self.searchClass = []
